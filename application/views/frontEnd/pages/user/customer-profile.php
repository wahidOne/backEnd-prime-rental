        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mt-1">
                    ...
                    <div class="col mt-1">
                        <p class="font-12px mb-0 text-dark">More :</p>
                        <a class="text-secondary ml-1" href="<?= base_url('user/' . $profile['user_id'] . '/dashboard/profile/change-password') ?>">Ubah Password</a>
                    </div>
                </div>
            </div>
        </div>
