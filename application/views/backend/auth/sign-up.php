                ...
                <div class="card">
                    <div class="row">
                        <div class="d-none d-md-flex col-md-6 col-lg-7  pr-md-0">
                            <div class="auth-register  py-3 col-md-10 mx-auto d-flex justify-content-end align-items-end ">
                                <h1 class=" position-absolute mt-md-2  text-white-50 display-1 font-weight-bolder ">Sign <span class="text-info">Up</span></h1>
                            </div>
                        </div>
                        <div class="col-md-6  col-lg-5 px-3 ">
                            <div class="auth-form-wrapper px-4 py-5">
                                ...
                                ?>
                                <form class="forms-sample m-0z" action="<?= base_url('administrator/sign-up') ?>" method="POST">
                                    ...
                                    <div class=" form-group ">
                                        ...
                                        <?= form_error('email', '<span class="text-danger m-1 pesan-validasi-input">', '</span>'); ?>
                                    </div>
                                    <div class=" form-group ">
                                        <input type="password" class="form-control text-info" id="password1" name="password1" placeholder="Kata Sandi">
                                        <?= form_error('password1', '<span class="text-danger m-1 pesan-validasi-input">', '</span>'); ?>
                                    </div>
                                    <div class="form-group ">
