		...
		!(function (t, n) {
			...
			var x = (function (e) {
				...
				(ae.attr = function (e, t) {
					...
					var r = i.attrHandle[t.toLowerCase()],
						o =
							r && N.call(i.attrHandle, t.toLowerCase()) ? r(e, t, !g) : void 0;
					return void 0 !== o
						? o
						: n.attributes || !g
						? e.getAttribute(t)
					...
					return (
						...
						ue(function (o, s, a, l) {
							var u,
								...
								v = n ? (r || (o ? e : p || i) ? [] : s) : m;
							if ((n && n(m, v, a, l), i))
								for (u = Ee(v, h), i(u, [], a, l), c = u.length; c--; )
									(f = u[c]) && (v[h[c]] = !(m[h[c]] = f));
							if (o) {
								if (r || e) {
									if (r) {
					...
					function (e, t) {
						T.fn[e] = function (n, i) {
							...
							return (
								...
								this.length > 1 &&
									(P[e] || T.uniqueSort(r), j.test(e) && r.reverse()),
								this.pushStack(r)
							);
						};
					}
						...
						var t = [
							...
							r = {
								...
								then: function (e, i, r) {
									...
									return T.Deferred(function (n) {
										t[0][3].add(s(0, n, v(r) ? r : R, n.notifyWith)),
											t[1][3].add(s(0, n, v(e) ? e : R)),
											t[2][3].add(s(0, n, v(i) ? i : M));
									}).promise();
								},
								promise: function (e) {
			...
			function Ee(e, t, n, i, r) {
				...
				for (f.textContent = "", h = 0; (o = d[h++]); )
					if (i && T.inArray(o, i) > -1) r && r.push(o);
						...
						((u = se(o)), (s = be(f.appendChild(o), "script")), u && _e(s), n)
					)
				...
				special: {
					...
					click: {
						...
						trigger: function (e) {
							var t = this || e;
							return (
								ge.test(t.type) && t.click && N(t, "input") && Ie(t, "click"),
								!0
							);
						},
						_default: function (e) {
			...
			function Me(e, t, n, i) {
				...
				var r,
					...
					p = t[0],
					g = v(p);
				if (g || (d > 1 && "string" == typeof p && !m.checkClone && ke.test(p)))
				...
				if (
					...
					for (a = (s = T.map(be(r, "script"), Pe)).length; f < d; f++)
						(u = r),
							f !== h &&
								((u = T.clone(u, !0, !0)), a && T.merge(s, be(u, "script"))),
							n.call(e[f], u, f);
					if (a)
						for (
			...
			function Fe(e, t, n) {
				for (var i, r = t ? T.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
					n || 1 !== i.nodeType || T.cleanData(be(i)),
						i.parentNode &&
							(n && se(i) && _e(be(i, "script")), i.parentNode.removeChild(i));
				return e;
			}
			T.extend({
			...
			function nt(e, t, n, i, r, o) {
				...
				for (; s < 4; s += 2)
					"margin" === n && (l += T.css(e, n + re[s], !0, r)),
						i
							? ("content" === n && (l -= T.css(e, "padding" + re[s], !0, r)),
							  "margin" !== n &&
									(l -= T.css(e, "border" + re[s] + "Width", !0, r)))
							: ((l += T.css(e, "padding" + re[s], !0, r)),
							  "padding" !== n
									? (l += T.css(e, "border" + re[s] + "Width", !0, r))
									: (a += T.css(e, "border" + re[s] + "Width", !0, r)));
				return (
					!i &&
						o >= 0 &&
						(l +=
			...
			function ht(e, t, n) {
				...
				for (
					...
					if ((i = ht.prefilters[o].call(u, e, c, u.opts)))
						return (
							v(i.stop) &&
			...
			T.extend(T.event, {
				trigger: function (e, t, i, r) {
					...
					if (
						...
						if (!r && !f.noBubble && !y(i)) {
							for (
								l = f.delegateType || g, Et.test(l + g) || (s = s.parentNode);
								s;
								s = s.parentNode
							)
								p.push(s), (a = s);
				...
				T.extend({
					...
					ajax: function (e, t) {
						...
						if (
							...
							if (((C.readyState = 1), c && g.trigger("ajaxSend", [C, h]), u))
								return C;
							h.async &&
								h.timeout > 0 &&
								...
								f
									? (h.ifModified &&
									  ...
									  204 === e || "HEAD" === h.type
											...
											: 304 === e
											? (E = "notmodified")
											: ((E = _.state), (d = _.data), (f = !(b = _.error))))
									: ((b = E), (!e && E) || ((E = "error"), e < 0 && (e = 0))),
								(C.status = e),
								(C.statusText = (t || E) + ""),
								f ? m.resolveWith(p, [d, E, C]) : m.rejectWith(p, [C, E, b]),
								C.statusCode(y),
								(y = void 0),
								c &&
									g.trigger(f ? "ajaxSuccess" : "ajaxError", [C, h, f ? d : b]),
								v.fireWith(p, [C, E]),
								c &&
			...
			T.ajaxSetup({
				...
				jsonpCallback: function () {
					var e = zt.pop() || T.expando + "_" + xt.guid++;
					return (this[e] = !0), e;
				},
			}),
				...
				T.each(["top", "left"], function (e, t) {
					T.cssHooks[t] = $e(m.pixelPosition, function (e, n) {
						if (n)
							return (n = Qe(e, t)), We.test(n) ? T(e).position()[t] + "px" : n;
					});
				}),
			...
			return (
				(T.noConflict = function (e) {
					return (
						n.$ === T && (n.$ = Jt), e && n.jQuery === T && (n.jQuery = Gt), T
					);
				}),
		...
		!(function (e, t, n) {
				...
				ie = (function () {
					...
					return (
						...
						(n._getConfig = function (e) {
							return (e = a({}, L, {}, e)), u.typeCheckConfig(I, e, j), e;
						}),
						...
						(n._addTouchEventListeners = function () {
							...
							if (this._touchSupported) {
								...
								t(this._element.querySelectorAll(G)).on(M.DRAG_START, function (
									e
								) {
			...
			t(document).on(M.CLICK_DATA_API, ee, ie._dataApiClickHandler),
				...
				(t.fn[I].noConflict = function () {
					return (t.fn[I] = k), ie._jQueryInterface;
				});
			var re = "collapse",
				oe = t.fn[re],
				se = { toggle: !0, parent: "" },
			...
			t(document)
				...
				.on(we.KEYDOWN_DATA_API, Oe, Be._dataApiKeydownHandler)
					...
					return (
						...
						(n.show = function (e) {
							...
							if (!this._isShown && !this._isTransitioning) {
								...
								var i = t.Event($e.SHOW, { relatedTarget: e });
						...
						(n._getConfig = function (e) {
							return (
								(e = a({}, Ke, {}, e)), u.typeCheckConfig("modal", e, Qe), e
							);
						}),
						...
						(n._showElement = function (e) {
							...
							(this._element.parentNode &&
								...
								t(this._dialog).hasClass(Ve) && r
									? (r.scrollTop = 0)
									: (this._element.scrollTop = 0),
								i && u.reflow(this._element),
								t(this._element).addClass(Je),
								this._config.focus && this._enforceFocus();
							var o = t.Event($e.SHOWN, { relatedTarget: e }),
								s = function () {
							...
							a.forEach(function (e) {
								(function (e, t) {
									...
									if (-1 !== t.indexOf(n))
										return (
											-1 === at.indexOf(n) ||
											Boolean(e.nodeValue.match(ut) || e.nodeValue.match(ct))
										);
									for (
			...
			var Ot = "popover",
				...
				Pt = a({}, It.DefaultType, { content: "(string|element|function)" }),
				Ht = "fade",
				qt = "show",
				Rt = ".popover-header",
				Mt = ".popover-body",
			...
			(t.fn[Ot] = Wt._jQueryInterface),
				(t.fn[Ot].Constructor = Wt),
				(t.fn[Ot].noConflict = function () {
					return (t.fn[Ot] = kt), Wt._jQueryInterface;
				});
			var Bt = "scrollspy",
				Ut = t.fn[Bt],
				...
				sn = (function () {
					...
					return (
						...
						(n._getConfig = function (e) {
							if (
								"string" !=
								typeof (e = a({}, Kt, {}, "object" == typeof e && e ? e : {}))
									.target
							) {
								var n = t(e.target).attr("id");
								n || ((n = u.getUID(Bt)), t(e.target).attr("id", n)),
									(e.target = "#" + n);
							}
						...
						(n._activate = function (e) {
							...
							i.hasClass(Vt)
								? (i.closest(en).find(nn).addClass(zt), i.addClass(zt))
								: (i.addClass(zt),
								  i
										.parents(Xt)
										.prev(Gt + ", " + Zt)
			...
			(t.fn.toast = On._jQueryInterface),
				...
				(t.fn.toast.noConflict = function () {
					return (t.fn.toast = En), On._jQueryInterface;
				}),
				(e.Alert = m),
				(e.Button = N),
				(e.Carousel = ie),
