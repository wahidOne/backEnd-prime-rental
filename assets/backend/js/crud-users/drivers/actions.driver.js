	...
	<div class="col-md-8 pt-md-0  mt-3 mt-md-0">
		...
		<div class="row px-2">
			...
			<div class="border-bottom col-8 px-3 py-2">
				<h5 class=" text-capitalize ">${data.driver_name}</h5>
			</div>
		</div>
		<br>
		<div class="row px-2">
			...
			<div class="border-bottom col-8 px-3 py-2">
				<h5 class=" text-capitalize ">${data.driver_ID_number}</h5>
			</div>
		</div>
		<br>
		<div class="row px-2">
		...
		<div class="row px-2">
			...
			<div class="border-bottom col-8 px-3 py-2">
				<h5 class=" text-capitalize ">${data.driver_phone}</h5>
			</div>
		</div>
		<br>
		<div class="row px-2">
			...
			<div class="border-bottom col-8 px-3 py-2">
				<h5 class=" text-capitalize ">${data.driver_status}</h5>
			</div>
		</div>
		<br>
		<div class="row px-2">
